...
<script src="assets/js/dxchat.js" type="text/javascript"></script>
<script src="assets/js/general.js" type="text/javascript"></script>
<!--
 <script src="assets/pinpad/jquery.ui.pinpad.js"></script>
<script src="assets/pinpad/jquery.ui.pinpad.extension.js"></script>
-->
...
<script>
    ...
    // var FunctionAPICall = function (request_type,params,callback) {
    //
    ...
    // var PrepareCustomerSelectBox= function(data) {
    //
    //     var select_options = "<option value=''>Select a customer</option>";
    //     $.each(data, function (key,data) {
    //         select_options += "<option value='"+data.debtor_no+"'>"+data.name+"</option>";
    //     });
    //
    //     $(".axispro_customer_select").html(select_options);
    //
    // }
