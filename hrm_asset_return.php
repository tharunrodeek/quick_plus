                        ...
                        <div class="kt-portlet__body" style="padding: 5px !important;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm">
                                    ...
                                    <div>
                                        <label class=""><?= trans('RETURN REQUEST COMMENTS') ?>:</label>
                            ...
                            <div class="col-md-16" style="margin-top: 5%;">
                                ...
                                <div class="table-responsive" >
                                    ...
                                    <table class="table table-bordered" id="asset_return_reuqests">
                                        <thead>
                                        <th><?= trans('Ref.No') ?></th>
...
<script>
   ...
   /* $('.ap-datepicker').datepicker({
    ...
    {
        $('#asset_return_reuqests').dataTable().fnDestroy();
        $('#asset_return_reuqests').DataTable({
            "bProcessing": true,
            "serverSide": true,
            "ajax":{
    ...
    $('#asset_return_reuqests tbody').on('click', 'td label.ClsBtnEdit', function (){
    ...
    $('#asset_return_reuqests tbody').on('click', 'td label.ClsBtnRemove', function (){
