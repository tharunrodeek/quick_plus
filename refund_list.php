            ...
            AxisPro.APICall('GET', ERP_FUNCTION_API_END_POINT, {
                ...
                if (data.length > 0) {
                    ...
                    $.each(data, function (key, val) {
                        ...
                        tbody_html += "<td>" + val.ref + "</td>";
                        tbody_html += "<td>" + val.trans_date + "</td>";
                        tbody_html += "<td>" + val.amount + "</td>";
                        tbody_html += "<td>" + val.name + "</td>";
                        //tbody_html += "<td>" + val.contact_person + "</td>";
                        tbody_html += "<td><a href="+val.print_url+" target='_blank' class='btn btn-sm btn-primary line-all'>PRINT REFUND VOUCHER</a></td>";
                        tbody_html += "</tr>";
                        cnt++;
