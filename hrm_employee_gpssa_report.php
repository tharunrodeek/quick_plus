                ...
                <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
                    ...
                    <div class="kt-container  kt-grid__item kt-grid__item--fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                    <div class="card-body" id="cashier-form-div">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h3>Employee GPSSA Report</h3>
                                            </div>
                                        </div>

                                        <div class="row">
                                           <div class="col-lg-12">
                                            <form id="form-filter" class="form-horizontal" method="POST" action="<?= $erp_url ?>API/hub.php?method=export_gpssa" style="width:100%;">
                            ...
                            <table id="gpssa_datatable" class="table dataTable" width="100%" cellspacing="0">
                                <thead>
                                    <tr>
                                        <th>DEPARTMENT</th>
                                        <th>EMPLOYEE NAME</th>
...
{
    $('#gpssa_datatable').dataTable().fnDestroy();

    emp_gpssa_table = $('#gpssa_datatable').dataTable({
        dom: 'Bfrtip',
        // stateSave: true,
        "bLengthChange": false,
        // "pageLength": 50,
        ...
        "searching": false,
        "ajax":{
            url :ERP_FUNCTION_API_END_POINT+"?method=get_emp_gpssa_list_for_datatable",
            type: "POST",
            "data": function ( data ) {
