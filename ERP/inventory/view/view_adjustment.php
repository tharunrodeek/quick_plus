...
while ($adjustment = db_fetch($adjustment_items))
{
	...
	if (!$header_shown)
	{
    	...
    	$th = array(trans("Item Code"), trans("Description"), trans("Quantity"),
    		trans("Units"), trans("Unit Cost"));
    	table_header($th);
	}
...
is_voided_display(ST_INVADJUST, $trans_no, trans("This adjustment has been voided."));
