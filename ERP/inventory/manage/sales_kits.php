...
echo "<center>" . trans("Select a sale kit:") . "&nbsp;";
echo sales_kits_list('item_code', null, trans('New kit'), true);
echo "</center><br>";
...
// New sales kit entry
	...
	text_row(trans("Alias/kit code:"), 'kit_code', null, 20, 21);
} else
{
	...
	sales_local_items_list_row(trans("Component:"),'component', null, false, true);
