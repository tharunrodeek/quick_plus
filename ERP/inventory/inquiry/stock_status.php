...
page(trans($help_context = "Inventory Item Status"), isset($_GET['stock_id']), false, "", $js);
...
{
	display_note(trans("This is a service and cannot have a stock holding, only the total quantity on outstanding sales orders is shown."), 0, 1);
...
{
	$th = array(trans("Location"), trans("Demand"));
}
else
{
	$th = array(trans("Location"), trans("Quantity On Hand"), trans("Re-Order Level"),
		trans("Demand"), trans("Available"), trans("On Order"));
}
table_header($th);
