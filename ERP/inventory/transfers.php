...
if (isset($_GET['NewTransfer'])) {
	if (isset($_GET['FixedAsset'])) {
		...
		$_SESSION['page_title'] = trans($help_context = "Fixed Assets Location Transfers");
	}
	else {
		$_SESSION['page_title'] = trans($help_context = "Inventory Location Transfers");
	}
}
...
if (isset($_GET['AddedID'])) 
{
  ...
  if (is_fixed_asset($itm['mb_flag']))
	  hyperlink_params($_SERVER['PHP_SELF'], trans("Enter &Another Fixed Assets Transfer"), "NewTransfer=1&FixedAsset=1");
  else
	  hyperlink_params($_SERVER['PHP_SELF'], trans("Enter &Another Inventory Transfer"), "NewTransfer=1");
...
start_row();
echo "<td>";
display_transfer_items(trans("Items"), $_SESSION['transfer_items']);
