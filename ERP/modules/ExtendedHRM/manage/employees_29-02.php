...
<input type=\"text\" name=\"date_of_birth\" id=\"datepicker-13\" value='".$_POST['date_of_birth']."'  /> <a tabindex=\"-1\" alt=\"date_of_birth\" autocomplete=\"off\">	</a>
</td>
</tr>";
...
echo "</select>
     ...
     /*  echo "<tr><td class=\"label\">".trans("Date of Join:")."</td><td>
        ...
        echo "<tr><td class=\"label\">".trans("Date of Join")."</td><td>
<input type=\"text\" name=\"joining\" id=\"datepicker-14\" value='".$_POST['joining']."' /> <a tabindex=\"-1\" alt=\"date_of_join\" >	</a>
</td>
</tr>";
