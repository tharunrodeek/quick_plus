...
department_list_row( trans("Department :"), 'department', $_POST['department'], false, true, false,false, true);
...
<input type=\"text\" name=\"joining\" id=\"datepicker-15\" value='".date('d-m-Y',strtotime($_POST['joining']))."' /> <a tabindex=\"-1\" alt=\"date_of_join\" >	<img src=\"../../../themes/daxis/images/cal.gif\" style=\"vertical-align:middle;padding-bottom:4px;width:16px;height:16px;border:0;\" alt=\"Click Here to Pick up the date\"></a>
</td>
</tr>";
