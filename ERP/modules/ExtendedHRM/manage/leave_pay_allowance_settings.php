...
page(trans("Leave Pay Allowance Settings"));
if (isset($_POST['addupdate'])) {		
    	...
    	Update('kv_empl_option', array('option_name' => 'leave_pay'), array('option_value' =>  $_POST['allowances']));   
		display_notification(trans("Selected Leave Pay Settings has been updated"));
}
//-------------------------------------------------------------------------------------------------
start_form();
start_table(TABLESTYLE2);
table_section_title(trans("Allowances"));
$myrow = unserialize(base64_decode(GetSingleValue('kv_empl_option','option_value',array('option_name' => 'leave_pay'))));
