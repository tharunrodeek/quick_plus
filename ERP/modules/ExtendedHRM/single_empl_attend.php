...
div_start('totals_tbl');
	...
	if(!get_post('empl_id')	) 
		...
		$info = GetRow('kv_empl_info', array('id' => get_post('empl_id')));
		$day_absentees = GetRow('kv_empl_attendancee', array('empl_id' => $_POST['empl_id'], 'month' => $_POST['month'], 'year' => $_POST['year']));
