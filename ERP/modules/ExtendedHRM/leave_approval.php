...
*****************************************/
$page_security = 'HRM_LEAVE_APPROVE';
$path_to_root = "../..";
...
if ($Mode=='ADD_ITEM' || $Mode=='UPDATE_ITEM'){
	...
	if ($input_error != 1)	{
    	...
    	if($_POST['status'] == 1){
            ...
            $sql_char = "SELECT char_code FROM ".TB_PREF."kv_empl_leave_types WHERE id = ".db_escape($_POST['leave_type'])." ";

            $res_get_leave_char = db_fetch(db_query($sql_char, "Can't get actual al"));
			...
			for($kv=1;$kv<=$_POST['days']; $kv++){
				...
				//if(in_array($day_letters, $weekly_off ))
					//continue;
				$array = array('in_time' => '00:00:00', 'out_time' => '00:00', 'duration' => 0, 'ot' => 0, 'sot' => 0, 'code' => $res_get_leave_char['char_code']);
