...
function print_check()
{
    ...
    // Begin the report
    $rep = new FrontReport(trans('Printable Check'), "PrintableCheck", user_pagesize());
  ...
  /////////////////////
    ...
    for ($section=1; $section<=2; $section++) 
    {
        ...
        $rep->TextCol(0, 3, sprintf( trans("Payment # %s - from Customer: %s - %s"), $tno,
        	$from_trans['supp_account_no'], $rep->company['coy_name']));
        
        // Add memo
        $rep->NewLine();
        $rep->TextCol(0, 3, trans("Memo: ").$memo);    
        ...
        // Add headers
        $rep->Font('b');
        $rep->TextCol(0, 1, trans("Type/Id"));
        $rep->TextCol(1, 2, trans("Trans Date"));
        $rep->TextCol(2, 3, trans("Due Date"));
        $rep->TextCol(3, 4, trans("Total Amount"));
        $rep->TextCol(4, 5, trans("Left to Allocate"));
        $rep->TextCol(5, 6, trans("This Allocation"));
        $rep->NewLine();
    	...
    	$rep->NewLine();
       	$rep->TextCol(4, 5, trans("Total Allocated"));
