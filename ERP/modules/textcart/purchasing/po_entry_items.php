...
// not yet
//	display_note(print_document_link($trans_no, trans("&Print This GRN"), true, $trans_type), 0, 1);
...
// not yet
//	display_note(print_document_link($trans_no, trans("&Print This Invoice"), true, $trans_type), 0, 1);
...
function can_commit()
{
	...
	if (!$_SESSION['PO']->order_no) 
	{
    	...
    	{
    		display_error(trans("There is no reference entered for this purchase order."));
			set_focus('ref');
    		return false;
    	} 
