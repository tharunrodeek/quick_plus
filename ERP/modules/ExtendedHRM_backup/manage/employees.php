...
<input type=\"text\" name=\"date_of_birth\" id=\"datepicker-13\" <a tabindex=\"-1\" alt=\"date_of_birth\">	<img src=\"../../../themes/daxis/images/cal.gif\" style=\"vertical-align:middle;padding-bottom:4px;width:16px;height:16px;border:0;\" alt=\"Click Here to Pick up the date\"></a>
</td>
</tr>";
...
<script>
/*
        $(".clsClander").click(function()
        {
            //alert('Haii');
            if($(this).attr('alt')=='date_of_birth')
            {
                $("#CC").css('margin-top','-58%');
            }
            if($(this).attr('alt')=='joining')
            {

                $("#CC").css('margin-top','-18%');
            }
        });*/
