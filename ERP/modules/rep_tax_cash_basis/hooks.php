...
class hooks_rep_tax_cash_basis extends hooks {
	...
	*/
	function install_options($app) {
		...
		switch($app->id) {
			case 'GL':
				$app->add_lapp_function(1, trans('Tax Inquiry (Cash Basis)'),
	...
	{
		$security_sections[SS_TAXREPCASH] =	trans("Tax Inquiry (Cash Basis)");

		$security_areas['SA_TAXREPCASH'] = array(SS_TAXREPCASH|101, trans("Tax Inquiry (Cash Basis)"));
