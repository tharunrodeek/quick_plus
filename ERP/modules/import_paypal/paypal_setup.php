...
page(trans($help_context = "Paypal Import Setup"));
...
if (isset($_POST['submit']) && can_process())
{
	...
	display_notification(trans("The Paypal setup has been updated."));
...
table_section_title(trans("Options"));
check_row(trans("Create Customers/Invoices:"), 'paypal_create_invoices', null);
check_row(trans("Use Paypal Transaction Id:"), 'use_paypal_trn_id', null);
check_row(trans("Receipts Date Today:"), 'paypal_recpt_today', null);
table_section_title(trans("PayPal File"));
text_row_ex(trans("Company Name Column:"), 'paypal_name_col', 25, 55);
table_section_title(trans("Customers"));
sales_types_list_row("Sales Type:", 'paypal_sales_type_id', null);
sales_persons_list_row( trans("Sales Person:"), 'paypal_salesman', null);
sales_areas_list_row( trans("Sales Area:"), 'paypal_area', null);
credit_status_list_row(trans("Credit Status:"), 'paypal_credit_status', null);
locations_list_row(trans("Default Location:"), 'paypal_location', null);
shippers_list_row(trans("Default Shipper:"), 'paypal_shipper', null);

table_section(2);

table_section_title(trans("Accounts"));
bank_accounts_list_row(trans("Bank Account:"), 'paypal_bank_id', $_POST['paypal_bank_id'], false);
gl_all_accounts_list_row(trans("Sales Account:"), 'paypal_sales_act', $_POST['paypal_sales_act']);
gl_all_accounts_list_row(trans("Sales Tax Account:"), 'paypal_sales_tax_act', $_POST['paypal_sales_tax_act']);
gl_all_accounts_list_row(trans("Shipping Account:"), 'paypal_shipping_act', $_POST['paypal_shipping_act']);
gl_all_accounts_list_row(trans("Fee Account:"), 'paypal_fee_act', $_POST['paypal_fee_act']);
gl_all_accounts_list_row(trans("Insurance Account:"), 'paypal_insurance_act', $_POST['paypal_insurance_act']);
bank_accounts_list_row(trans("Withdrawal Account:"), 'paypal_withdraw_id', $_POST['paypal_withdraw_id'], false);
table_section_title(trans("Tax"));
check_row(trans("Add Tax to Receipts:"), 'paypal_add_tax', null);
check_row(trans("Tax Included in Paypal Amount:"), 'paypal_tax_included', null);
