...
class hooks_repgen extends hooks {
	...
	*/
	function install_options($app) {
		...
		switch($app->id) {
			case 'system':
				$app->add_rapp_function( 2, trans("&Report Generator"),
	...
	function install_access()
	{
		...
		$security_sections[SS_REPORT_GENERATOR] =	trans("Report Generator");

		$security_areas['SA_REPORT_GENERATOR'] = array(SS_REPORT_GENERATOR|130, trans("Report Generator"));
