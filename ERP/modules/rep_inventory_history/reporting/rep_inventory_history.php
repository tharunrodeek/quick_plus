...
function print_inventory_history()
{
	...
	$headers = array(trans('Category'), '', trans('UOM'), trans('Adjustment'), trans('Production'),  trans('GRN'),  trans('SuppCredit'),trans('Transfer'), 
		trans('Delivery'),  trans('CustCredit'),trans('QOH'));
    ...
    $rep = new FrontReport(trans('Inventory History'), "InventoryHistory", user_pagesize(), 10, 'L');
