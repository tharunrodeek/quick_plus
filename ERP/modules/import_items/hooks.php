...
class hooks_import_items extends hooks {
	...
	*/
	function install_options($app) {
		...
		switch($app->id) {
			case 'stock':
				$app->add_rapp_function(2, trans('Import CSV Items'),
	...
	{
		$security_sections[SS_IMPORTCSVITEMS] =	trans("Import CSV Items");

		$security_areas['SA_CSVIMPORT'] = array(SS_IMPORTCSVITEMS|105, trans("Import CSV Items"));
