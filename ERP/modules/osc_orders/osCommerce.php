...
else hyperlink_params($_SERVER['PHP_SELF'], trans("Summary"), "action=summary", false);
echo '&nbsp;|&nbsp;';
if ($action == 'show') echo 'Configuration';
else hyperlink_params($_SERVER['PHP_SELF'], trans("Configuration"), "action=show", false);
echo '&nbsp;|&nbsp;';
if ($action == 'cimport') echo 'Customer Import';
else hyperlink_params($_SERVER['PHP_SELF'], trans("&Customer Import"), "action=cimport", false);
echo '&nbsp;|&nbsp;';
if ($action == 'oimport') echo 'Order Import';
else hyperlink_params($_SERVER['PHP_SELF'], trans("&Order Import"), "action=oimport", false);
echo '&nbsp;|&nbsp;';
if ($action == 'pcheck') echo 'Price Check';
else hyperlink_params($_SERVER['PHP_SELF'], trans("&Price Check"), "action=pcheck", false);
echo '&nbsp;|&nbsp;';
if ($action == 'pupdate') echo 'Update Prices';
else hyperlink_params($_SERVER['PHP_SELF'], trans("&Update Prices"), "action=pupdate", false);
echo "<br><br>";
...
if ($action == 'show') {
	...
	if ($found) {
    	...
    	tax_groups_list_row(trans("Default Tax Group:"), 'taxgroup', $default_TaxGroup);
	}
...
if ($action == 'cimport') {
    ...
    tax_groups_list_row(trans("Default Tax Group:"), 'tax_group_id', $default_TaxGroup);
	...
	amount_row(trans("Credit Limit:"), 'credit_limit', $credit_limit);
...
if ($action == 'pcheck') {
    ...
    hyperlink_params($_SERVER['PHP_SELF'], trans("Refresh"), "action=pcheck");
    end_page();
}
if ($action == 'pupdate') {
