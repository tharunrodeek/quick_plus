...
function print_stock_check()
{
	...
	$headers = array(trans('Stock ID'), trans('Description'), trans('Quantity'));
    ...
    $params =   array( 	0 => $comments,
						...
						2 => array('text' => trans('Date'), 'from' => $rep_date, 'to' => '')
    				  );

	$user_comp = "";

    $rep = new FrontReport(trans('Dated Stock Sheet'), "DatedStockSheet", user_pagesize());
