...
function print_assets_list()
{
	...
	$headers = array(trans('Asset Type'), trans('Asset name'), trans('Serial Number'), trans('Purchase Date'), trans('Purchase Value'));
    ...
    $rep = new FrontReport(trans('Assets Listing'), "AssetList", user_pagesize());
