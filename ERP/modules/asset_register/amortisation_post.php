...
$th = array(trans("Asset Type"),trans("Asset Name"),trans("Serial Number"), trans("Purchase Date"), trans("Purchase Price"), trans("Disposal Date"), trans("Disposal Amount"));
...
$th = array(trans("Name"),trans("Serial Number"),trans("Valuation Year"),trans("Asset Value"),trans("Value Change"));
inactive_control_column($th);
table_header($th);
$k = 0;
...
$th = array(trans("Name"),trans("Serial Number"),trans("Year"),trans("Asset Value"),trans("Depreciation"));
inactive_control_column($th);
table_header($th);
$k = 0;
