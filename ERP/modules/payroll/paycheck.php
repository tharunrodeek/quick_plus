...
function list_employees_pay_table($table) {
    ...
    // div_start('controls');
    if ($table == 'begin') {
        submit_center('PreProcess', trans("Proceed"), true, true, 'default');
    } else if ($table == 'review') {
        submit_center_first('Start', trans("Back"), true, true, 'default');
        submit_center_last('Process', trans("Process"), true, true, 'default');
    }
    div_end();
}
