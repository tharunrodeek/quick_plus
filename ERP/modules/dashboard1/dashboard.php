...
class dashboard_app extends application
{
	...
	{
		$this->application("Dashboard", trans($this->help_context = "&Dashboard"));

        //$this->add_module(trans("Dashboard"));
        $this->widgets = array();
        $this->add_extensions();

        $this->apps = array("orders"=>trans("Sales"),
                        "AP"=>trans("Purchases"),
                        "stock"=>trans("Items and Inventory"),
                        "manuf"=>trans("Manufacturing"),
                        "GL"=>trans("Banking and General Ledger"),
