...
class banktransactions
{
    ...
    function render($id, $title)
    {
        ...
        $th = array(trans("#"), trans("Date"),
            trans("Receipt"), trans("Payment"), trans("Balance"), trans("Person/Item"), trans("Memo"), "");
        table_header($th);
        ...
        label_cell(trans("Opening Balance")." - ".$start_date, "colspan=4");
        ...
        start_row("class='inquirybg' style='font-weight:bold'");
        label_cell(trans("Ending Balance")." - ". $end_date, "colspan=4");
    ...
    function edit_param()
    {
        ...
        text_row_ex(trans("Days in past:"), 'days_past', 2);
        text_row_ex(trans("Days in future:"), 'days_future', 2);
        bank_accounts_list_cells(trans("Account:"), 'bank_act', null);
        text_row_ex(trans("Filter:"), 'data_filter', 50);
    }
    ...
    function validate_param()
    {
        ...
        //  {
        //      $input_error = 1;
        //      display_error( trans("The number of weeks must be numeric."));
        //      set_focus('top');
        //  }
