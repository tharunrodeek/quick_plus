...
function drawChart".$id."() {
  ...
  chart".$id.".draw(data, options);
    ...
    function edit_param()
    {
        ...
        $graph_types = array(
            'LineChart' => trans("Line Chart"),
            'ColumnChart' => trans("Column Chart"),
            'Table' => trans("Table")
        );
        $_POST['top'] = $this->top;
        ...
        text_row_ex(trans("Number of weeks:"), 'top', 2);
        select_row(trans("Sequence"), "orderby", null, $sequences, null);
        select_row(trans("Order"), "orderby_seq", null, $asc_desc, null);
        text_row_ex(trans("Filter:"), 'data_filter', 50);
        select_row(trans("Graph Type"), "graph_type", null, $graph_types, null);
    }
