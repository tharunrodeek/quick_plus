...
page(trans($help_context = "Dashboard Setup"));
...
if ($Mode == 'Delete')
{
	...
	display_notification(trans('Selected widget has been deleted'));
...
$th = array(trans("Application"), trans("Widget"), trans("Description"),trans("Column"), trans("Sequence"), trans("Collapsed"),  "", "");
...
widget_list_row($app->get_widget_list(), trans("Widget:"), 'widget', null, true);
text_row_ex(trans("Title:"), 'description', 40);
select_row(trans("Application Tab:"), "widget_app", null, $app->apps, null);
text_row_ex(trans("Column:"), 'column_id', 1);
text_row_ex(trans("Sequence:"), 'sort_no', 1);
check_row(trans("Collapsed:"), 'collapsed');
include_once ($path_to_root.$widget->path);
$className = $widget->name;
