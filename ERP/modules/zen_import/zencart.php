...
if ($found) {
	$zen = zen_connect();
	if(!$zen)
		display_error(trans("Failed to connect to Zen Cart Database"));
...
page(trans($help_context = "zencart Interface"));
...
if ($action == 'show') {
    ...
    currencies_list_row(trans("Default Currency:"), 'currency', $default_Currency);
