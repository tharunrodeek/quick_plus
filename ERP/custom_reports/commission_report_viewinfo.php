...
$commission_report_view = NULL;

//
// Table class for commission_report_view
//
class ccommission_report_view extends cTable {
	var $invoice_no;
	...
	function __construct() {
		...
		$this->TableVar = 'commission_report_view';
		$this->TableName = 'commission_report_view';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`commission_report_view`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// invoice_no
		$this->invoice_no = new cField('commission_report_view', 'commission_report_view', 'x_invoice_no', 'invoice_no', '`invoice_no`', '`invoice_no`', 200, -1, FALSE, '`invoice_no`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->invoice_no->Sortable = TRUE; // Allow sort
		$this->fields['invoice_no'] = &$this->invoice_no;

		// transaction_date
		$this->transaction_date = new cField('commission_report_view', 'commission_report_view', 'x_transaction_date', 'transaction_date', '`transaction_date`', ew_CastDateFieldForLike('`transaction_date`', 2, "DB"), 133, 2, FALSE, '`transaction_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// description
		$this->description = new cField('commission_report_view', 'commission_report_view', 'x_description', 'description', '`description`', '`description`', 200, -1, FALSE, '`description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->description->Sortable = TRUE; // Allow sort
		$this->fields['description'] = &$this->description;

		// customer_name
		$this->customer_name = new cField('commission_report_view', 'commission_report_view', 'x_customer_name', 'customer_name', '`customer_name`', '`customer_name`', 200, -1, FALSE, '`customer_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// reference_customer
		$this->reference_customer = new cField('commission_report_view', 'commission_report_view', 'x_reference_customer', 'reference_customer', '`reference_customer`', '`reference_customer`', 200, -1, FALSE, '`reference_customer`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->reference_customer->Sortable = TRUE; // Allow sort
		$this->fields['reference_customer'] = &$this->reference_customer;

		// created_employee
		$this->created_employee = new cField('commission_report_view', 'commission_report_view', 'x_created_employee', 'created_employee', '`created_employee`', '`created_employee`', 200, -1, FALSE, '`created_employee`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// user_commission
		$this->user_commission = new cField('commission_report_view', 'commission_report_view', 'x_user_commission', 'user_commission', '`user_commission`', '`user_commission`', 5, -1, FALSE, '`user_commission`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// quantity
		$this->quantity = new cField('commission_report_view', 'commission_report_view', 'x_quantity', 'quantity', '`quantity`', '`quantity`', 5, -1, FALSE, '`quantity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->quantity->Sortable = TRUE; // Allow sort
		$this->quantity->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['quantity'] = &$this->quantity;

		// total_commission
		$this->total_commission = new cField('commission_report_view', 'commission_report_view', 'x_total_commission', 'total_commission', '`total_commission`', '`total_commission`', 5, -1, FALSE, '`total_commission`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// invoice_amount
		$this->invoice_amount = new cField('commission_report_view', 'commission_report_view', 'x_invoice_amount', 'invoice_amount', '`invoice_amount`', '`invoice_amount`', 5, -1, FALSE, '`invoice_amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// stock_id
		$this->stock_id = new cField('commission_report_view', 'commission_report_view', 'x_stock_id', 'stock_id', '`stock_id`', '`stock_id`', 200, -1, FALSE, '`stock_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// unit_price
		$this->unit_price = new cField('commission_report_view', 'commission_report_view', 'x_unit_price', 'unit_price', '`unit_price`', '`unit_price`', 5, -1, FALSE, '`unit_price`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// unit_tax
		$this->unit_tax = new cField('commission_report_view', 'commission_report_view', 'x_unit_tax', 'unit_tax', '`unit_tax`', '`unit_tax`', 5, -1, FALSE, '`unit_tax`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// discount_percent
		$this->discount_percent = new cField('commission_report_view', 'commission_report_view', 'x_discount_percent', 'discount_percent', '`discount_percent`', '`discount_percent`', 5, -1, FALSE, '`discount_percent`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// discount_amount
		$this->discount_amount = new cField('commission_report_view', 'commission_report_view', 'x_discount_amount', 'discount_amount', '`discount_amount`', '`discount_amount`', 5, -1, FALSE, '`discount_amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// govt_fee
		$this->govt_fee = new cField('commission_report_view', 'commission_report_view', 'x_govt_fee', 'govt_fee', '`govt_fee`', '`govt_fee`', 5, -1, FALSE, '`govt_fee`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// bank_service_charge
		$this->bank_service_charge = new cField('commission_report_view', 'commission_report_view', 'x_bank_service_charge', 'bank_service_charge', '`bank_service_charge`', '`bank_service_charge`', 5, -1, FALSE, '`bank_service_charge`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->bank_service_charge_vat = new cField('commission_report_view', 'commission_report_view', 'x_bank_service_charge_vat', 'bank_service_charge_vat', '`bank_service_charge_vat`', '`bank_service_charge_vat`', 5, -1, FALSE, '`bank_service_charge_vat`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// pf_amount
		$this->pf_amount = new cField('commission_report_view', 'commission_report_view', 'x_pf_amount', 'pf_amount', '`pf_amount`', '`pf_amount`', 5, -1, FALSE, '`pf_amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// transaction_id
		$this->transaction_id = new cField('commission_report_view', 'commission_report_view', 'x_transaction_id', 'transaction_id', '`transaction_id`', '`transaction_id`', 200, -1, FALSE, '`transaction_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->transaction_id->Sortable = TRUE; // Allow sort
		$this->fields['transaction_id'] = &$this->transaction_id;

		// created_by
		$this->created_by = new cField('commission_report_view', 'commission_report_view', 'x_created_by', 'created_by', '`created_by`', '`created_by`', 3, -1, FALSE, '`created_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->created_by->Sortable = TRUE; // Allow sort
		$this->created_by->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['created_by'] = &$this->created_by;

		// updated_by
		$this->updated_by = new cField('commission_report_view', 'commission_report_view', 'x_updated_by', 'updated_by', '`updated_by`', '`updated_by`', 3, -1, FALSE, '`updated_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`commission_report_view`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "commission_report_viewlist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		global $Language;
		if ($pageName == "commission_report_viewview.php")
			return $Language->Phrase("View");
		elseif ($pageName == "commission_report_viewedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "commission_report_viewadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("commission_report_viewview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("commission_report_viewview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "commission_report_viewadd.php?" . $this->UrlParm($parm);
		else
			$url = "commission_report_viewadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("commission_report_viewedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("commission_report_viewadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("commission_report_viewdelete.php", $this->UrlParm());
	}
