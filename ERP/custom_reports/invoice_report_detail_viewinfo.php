...
$invoice_report_detail_view = NULL;

//
// Table class for invoice_report_detail_view
//
class cinvoice_report_detail_view extends cTable {
	var $invoice_no;
	...
	function __construct() {
		...
		$this->TableVar = 'invoice_report_detail_view';
		$this->TableName = 'invoice_report_detail_view';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`invoice_report_detail_view`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// invoice_no
		$this->invoice_no = new cField('invoice_report_detail_view', 'invoice_report_detail_view', 'x_invoice_no', 'invoice_no', '`invoice_no`', '`invoice_no`', 200, -1, FALSE, '`invoice_no`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->invoice_no->Sortable = TRUE; // Allow sort
		$this->fields['invoice_no'] = &$this->invoice_no;

		// transaction_date
		$this->transaction_date = new cField('invoice_report_detail_view', 'invoice_report_detail_view', 'x_transaction_date', 'transaction_date', '`transaction_date`', ew_CastDateFieldForLike('`transaction_date`', 7, "DB"), 133, 7, FALSE, '`transaction_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->transaction_date->Sortable = TRUE; // Allow sort
		$this->transaction_date->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_SEPARATOR"], $Language->Phrase("IncorrectDateDMY"));
		$this->fields['transaction_date'] = &$this->transaction_date;

		// customer_name
		$this->customer_name = new cField('invoice_report_detail_view', 'invoice_report_detail_view', 'x_customer_name', 'customer_name', '`customer_name`', '`customer_name`', 200, -1, FALSE, '`customer_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// reference_customer
		$this->reference_customer = new cField('invoice_report_detail_view', 'invoice_report_detail_view', 'x_reference_customer', 'reference_customer', '`reference_customer`', '`reference_customer`', 200, -1, FALSE, '`reference_customer`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->reference_customer->Sortable = TRUE; // Allow sort
		$this->fields['reference_customer'] = &$this->reference_customer;

		// service_eng_name
		$this->service_eng_name = new cField('invoice_report_detail_view', 'invoice_report_detail_view', 'x_service_eng_name', 'service_eng_name', '`service_eng_name`', '`service_eng_name`', 200, -1, FALSE, '`service_eng_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->service_eng_name->Sortable = FALSE; // Allow sort
		$this->fields['service_eng_name'] = &$this->service_eng_name;

		// description
		$this->description = new cField('invoice_report_detail_view', 'invoice_report_detail_view', 'x_description', 'description', '`description`', '`description`', 200, -1, FALSE, '`description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->description->Sortable = TRUE; // Allow sort
		$this->fields['description'] = &$this->description;

		// category_id
		$this->category_id = new cField('invoice_report_detail_view', 'invoice_report_detail_view', 'x_category_id', 'category_id', '`category_id`', '`category_id`', 3, -1, FALSE, '`category_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// unit_price
		$this->unit_price = new cField('invoice_report_detail_view', 'invoice_report_detail_view', 'x_unit_price', 'unit_price', '`unit_price`', '`unit_price`', 5, -1, FALSE, '`unit_price`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// quantity
		$this->quantity = new cField('invoice_report_detail_view', 'invoice_report_detail_view', 'x_quantity', 'quantity', '`quantity`', '`quantity`', 5, -1, FALSE, '`quantity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->quantity->Sortable = TRUE; // Allow sort
		$this->quantity->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['quantity'] = &$this->quantity;

		// total_price
		$this->total_price = new cField('invoice_report_detail_view', 'invoice_report_detail_view', 'x_total_price', 'total_price', '`total_price`', '`total_price`', 5, -1, FALSE, '`total_price`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// unit_tax
		$this->unit_tax = new cField('invoice_report_detail_view', 'invoice_report_detail_view', 'x_unit_tax', 'unit_tax', '`unit_tax`', '`unit_tax`', 5, -1, FALSE, '`unit_tax`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// total_tax
		$this->total_tax = new cField('invoice_report_detail_view', 'invoice_report_detail_view', 'x_total_tax', 'total_tax', '`total_tax`', '`total_tax`', 5, -1, FALSE, '`total_tax`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// discount_amount
		$this->discount_amount = new cField('invoice_report_detail_view', 'invoice_report_detail_view', 'x_discount_amount', 'discount_amount', '`discount_amount`', '`discount_amount`', 5, -1, FALSE, '`discount_amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// govt_fee
		$this->govt_fee = new cField('invoice_report_detail_view', 'invoice_report_detail_view', 'x_govt_fee', 'govt_fee', '`govt_fee`', '`govt_fee`', 5, -1, FALSE, '`govt_fee`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// total_govt_fee
		$this->total_govt_fee = new cField('invoice_report_detail_view', 'invoice_report_detail_view', 'x_total_govt_fee', 'total_govt_fee', '`total_govt_fee`', '`total_govt_fee`', 5, -1, FALSE, '`total_govt_fee`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// bank_service_charge
		$this->bank_service_charge = new cField('invoice_report_detail_view', 'invoice_report_detail_view', 'x_bank_service_charge', 'bank_service_charge', '`bank_service_charge`', '`bank_service_charge`', 5, -1, FALSE, '`bank_service_charge`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->bank_service_charge_vat = new cField('invoice_report_detail_view', 'invoice_report_detail_view', 'x_bank_service_charge_vat', 'bank_service_charge_vat', '`bank_service_charge_vat`', '`bank_service_charge_vat`', 5, -1, FALSE, '`bank_service_charge_vat`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// pf_amount
		$this->pf_amount = new cField('invoice_report_detail_view', 'invoice_report_detail_view', 'x_pf_amount', 'pf_amount', '`pf_amount`', '`pf_amount`', 5, -1, FALSE, '`pf_amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->total_customer_commission = new cField('invoice_report_detail_view', 'invoice_report_detail_view', 'x_total_customer_commission', 'total_customer_commission', '`total_customer_commission`', '`total_customer_commission`', 5, -1, FALSE, '`total_customer_commission`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// reward_amount
		$this->reward_amount = new cField('invoice_report_detail_view', 'invoice_report_detail_view', 'x_reward_amount', 'reward_amount', '`reward_amount`', '`reward_amount`', 5, -1, FALSE, '`reward_amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// user_commission
		$this->user_commission = new cField('invoice_report_detail_view', 'invoice_report_detail_view', 'x_user_commission', 'user_commission', '`user_commission`', '`user_commission`', 5, -1, FALSE, '`user_commission`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// transaction_id
		$this->transaction_id = new cField('invoice_report_detail_view', 'invoice_report_detail_view', 'x_transaction_id', 'transaction_id', '`transaction_id`', '`transaction_id`', 201, -1, FALSE, '`transaction_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->transaction_id->Sortable = TRUE; // Allow sort
		$this->fields['transaction_id'] = &$this->transaction_id;

		// created_employee
		$this->created_employee = new cField('invoice_report_detail_view', 'invoice_report_detail_view', 'x_created_employee', 'created_employee', '`created_employee`', '`created_employee`', 200, -1, FALSE, '`created_employee`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// payment_status
		$this->payment_status = new cField('invoice_report_detail_view', 'invoice_report_detail_view', 'x_payment_status', 'payment_status', '`payment_status`', '`payment_status`', 200, -1, FALSE, '`payment_status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// payment_method
		$this->payment_method = new cField('invoice_report_detail_view', 'invoice_report_detail_view', 'x_payment_method', 'payment_method', '`payment_method`', '`payment_method`', 200, -1, FALSE, '`payment_method`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->payment_method->Sortable = TRUE; // Allow sort
		$this->payment_method->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->payment_method->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->payment_method->OptionCount = 3;
		$this->fields['payment_method'] = &$this->payment_method;

		// net_service_charge
		$this->net_service_charge = new cField('invoice_report_detail_view', 'invoice_report_detail_view', 'x_net_service_charge', 'net_service_charge', '`net_service_charge`', '`net_service_charge`', 5, -1, FALSE, '`net_service_charge`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// invoice_amount
		$this->invoice_amount = new cField('invoice_report_detail_view', 'invoice_report_detail_view', 'x_invoice_amount', 'invoice_amount', '`invoice_amount`', '`invoice_amount`', 5, -1, FALSE, '`invoice_amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// stock_id
		$this->stock_id = new cField('invoice_report_detail_view', 'invoice_report_detail_view', 'x_stock_id', 'stock_id', '`stock_id`', '`stock_id`', 200, -1, FALSE, '`stock_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// discount_percent
		$this->discount_percent = new cField('invoice_report_detail_view', 'invoice_report_detail_view', 'x_discount_percent', 'discount_percent', '`discount_percent`', '`discount_percent`', 5, -1, FALSE, '`discount_percent`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->discount_percent->Sortable = FALSE; // Allow sort
		$this->discount_percent->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['discount_percent'] = &$this->discount_percent;

		// created_by
		$this->created_by = new cField('invoice_report_detail_view', 'invoice_report_detail_view', 'x_created_by', 'created_by', '`created_by`', '`created_by`', 3, -1, FALSE, '`created_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->created_by->Sortable = TRUE; // Allow sort
		$this->created_by->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['created_by'] = &$this->created_by;

		// updated_by
		$this->updated_by = new cField('invoice_report_detail_view', 'invoice_report_detail_view', 'x_updated_by', 'updated_by', '`updated_by`', '`updated_by`', 3, -1, FALSE, '`updated_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`invoice_report_detail_view`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "invoice_report_detail_viewlist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		global $Language;
		if ($pageName == "invoice_report_detail_viewview.php")
			return $Language->Phrase("View");
		elseif ($pageName == "invoice_report_detail_viewedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "invoice_report_detail_viewadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("invoice_report_detail_viewview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("invoice_report_detail_viewview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "invoice_report_detail_viewadd.php?" . $this->UrlParm($parm);
		else
			$url = "invoice_report_detail_viewadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("invoice_report_detail_viewedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("invoice_report_detail_viewadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("invoice_report_detail_viewdelete.php", $this->UrlParm());
	}
	...
	function RenderEditRow() {
		...
		$this->transaction_date->EditValue = ew_FormatDateTime($this->transaction_date->CurrentValue, 7);
		...
		if (strval($this->unit_tax->EditValue) <> "" && is_numeric($this->unit_tax->EditValue)) $this->unit_tax->EditValue = ew_FormatNumber($this->unit_tax->EditValue, -2, -2, -2, -2);
		...
		if (strval($this->total_customer_commission->EditValue) <> "" && is_numeric($this->total_customer_commission->EditValue)) $this->total_customer_commission->EditValue = ew_FormatNumber($this->total_customer_commission->EditValue, -2, -2, -2, -2);
		...
		if (strval($this->reward_amount->EditValue) <> "" && is_numeric($this->reward_amount->EditValue)) $this->reward_amount->EditValue = ew_FormatNumber($this->reward_amount->EditValue, -2, -2, -2, -2);
		...
		if (strval($this->net_service_charge->EditValue) <> "" && is_numeric($this->net_service_charge->EditValue)) $this->net_service_charge->EditValue = ew_FormatNumber($this->net_service_charge->EditValue, -2, -1, -2, -2);
	...
	function ExportDocument(&$Doc, &$Recordset, $StartRec, $StopRec, $ExportPageType = "") {
		...
		if ($Doc->Horizontal) {
			...
			if (!$Doc->ExportCustom) {
				...
				if ($this->service_eng_name->Exportable) $Doc->ExportAggregate($this->service_eng_name, '');
				if ($this->category_id->Exportable) $Doc->ExportAggregate($this->category_id, '');
				if ($this->unit_price->Exportable) $Doc->ExportAggregate($this->unit_price, '');
				if ($this->quantity->Exportable) $Doc->ExportAggregate($this->quantity, '');
				if ($this->total_price->Exportable) $Doc->ExportAggregate($this->total_price, '');
				if ($this->unit_tax->Exportable) $Doc->ExportAggregate($this->unit_tax, '');
				if ($this->total_tax->Exportable) $Doc->ExportAggregate($this->total_tax, '');
				if ($this->discount_amount->Exportable) $Doc->ExportAggregate($this->discount_amount, '');
				if ($this->govt_fee->Exportable) $Doc->ExportAggregate($this->govt_fee, '');
				if ($this->total_govt_fee->Exportable) $Doc->ExportAggregate($this->total_govt_fee, '');
				if ($this->bank_service_charge->Exportable) $Doc->ExportAggregate($this->bank_service_charge, '');
				if ($this->bank_service_charge_vat->Exportable) $Doc->ExportAggregate($this->bank_service_charge_vat, '');
				if ($this->pf_amount->Exportable) $Doc->ExportAggregate($this->pf_amount, '');
				if ($this->total_customer_commission->Exportable) $Doc->ExportAggregate($this->total_customer_commission, '');
				if ($this->reward_amount->Exportable) $Doc->ExportAggregate($this->reward_amount, '');
				if ($this->user_commission->Exportable) $Doc->ExportAggregate($this->user_commission, '');
				if ($this->transaction_id->Exportable) $Doc->ExportAggregate($this->transaction_id, '');
				if ($this->created_employee->Exportable) $Doc->ExportAggregate($this->created_employee, '');
				if ($this->payment_status->Exportable) $Doc->ExportAggregate($this->payment_status, '');
				if ($this->payment_method->Exportable) $Doc->ExportAggregate($this->payment_method, '');
				if ($this->net_service_charge->Exportable) $Doc->ExportAggregate($this->net_service_charge, 'TOTAL');
				if ($this->invoice_amount->Exportable) $Doc->ExportAggregate($this->invoice_amount, 'TOTAL');
				$Doc->EndExportRow();
			}
		}
		if (!$Doc->ExportCustom) {
