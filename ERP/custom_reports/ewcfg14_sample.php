...
define("EW_PROJECT_NAME", "amer_reports", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{46DD0EDD-E9C9-44DF-9E61-DEAB99FDD850}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'e4OF6kfdgB7Vhpf4', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/amer_reports.css", TRUE); // Project stylesheet file name
...
$EW_JAVASCRIPT_FILES[] = "$(\"[data-name='stock_id']\").hide();";
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "db_axispro_new_version",  "qs" => "`", "qe" => "`");
...
define("EW_USER_TABLE", "`0_users`", TRUE);
...
define("EW_PDF_TIME_LIMIT", 600, TRUE); // Time limit
?>
