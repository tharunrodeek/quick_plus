...
class cchangepwd extends c_0_users {
	...
	function __construct() {
		...
		if (!isset($GLOBALS["_0_users"]) || get_class($GLOBALS["_0_users"]) == "c_0_users") {
			$GLOBALS["_0_users"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["_0_users"];
		}
		if (!isset($GLOBALS["_0_users"])) $GLOBALS["_0_users"] = &$this;
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel($this->ProjectID . '0_users');
		}
	...
	function Page_Main() {
		...
		if ($bPostBack && $bValidate) {
			...
			// SQL constructor in _0_users class, _0_usersinfo.php
