...
$customer_commission_report_view = NULL;

//
// Table class for customer_commission_report_view
//
class ccustomer_commission_report_view extends cTable {
	var $invoice_no;
	var $transaction_date;
	var $description;
	var $customer_name;
	var $reference_customer;
	var $customer_commission;
	var $quantity;
	...
	function __construct() {
		...
		$this->TableVar = 'customer_commission_report_view';
		$this->TableName = 'customer_commission_report_view';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`customer_commission_report_view`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// invoice_no
		$this->invoice_no = new cField('customer_commission_report_view', 'customer_commission_report_view', 'x_invoice_no', 'invoice_no', '`invoice_no`', '`invoice_no`', 200, -1, FALSE, '`invoice_no`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->invoice_no->Sortable = TRUE; // Allow sort
		$this->fields['invoice_no'] = &$this->invoice_no;

		// transaction_date
		$this->transaction_date = new cField('customer_commission_report_view', 'customer_commission_report_view', 'x_transaction_date', 'transaction_date', '`transaction_date`', ew_CastDateFieldForLike('`transaction_date`', 2, "DB"), 133, 2, FALSE, '`transaction_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// description
		$this->description = new cField('customer_commission_report_view', 'customer_commission_report_view', 'x_description', 'description', '`description`', '`description`', 200, -1, FALSE, '`description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->description->Sortable = TRUE; // Allow sort
		$this->fields['description'] = &$this->description;

		// customer_name
		$this->customer_name = new cField('customer_commission_report_view', 'customer_commission_report_view', 'x_customer_name', 'customer_name', '`customer_name`', '`customer_name`', 200, -1, FALSE, '`customer_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// reference_customer
		$this->reference_customer = new cField('customer_commission_report_view', 'customer_commission_report_view', 'x_reference_customer', 'reference_customer', '`reference_customer`', '`reference_customer`', 200, -1, FALSE, '`reference_customer`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->reference_customer->Sortable = TRUE; // Allow sort
		$this->fields['reference_customer'] = &$this->reference_customer;

		// customer_commission
		$this->customer_commission = new cField('customer_commission_report_view', 'customer_commission_report_view', 'x_customer_commission', 'customer_commission', '`customer_commission`', '`customer_commission`', 5, -1, FALSE, '`customer_commission`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->customer_commission->Sortable = TRUE; // Allow sort
		$this->customer_commission->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['customer_commission'] = &$this->customer_commission;

		// quantity
		$this->quantity = new cField('customer_commission_report_view', 'customer_commission_report_view', 'x_quantity', 'quantity', '`quantity`', '`quantity`', 5, -1, FALSE, '`quantity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->quantity->Sortable = TRUE; // Allow sort
		$this->quantity->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['quantity'] = &$this->quantity;

		// total_customer_commission
		$this->total_customer_commission = new cField('customer_commission_report_view', 'customer_commission_report_view', 'x_total_customer_commission', 'total_customer_commission', '`total_customer_commission`', '`total_customer_commission`', 5, -1, FALSE, '`total_customer_commission`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// stock_id
		$this->stock_id = new cField('customer_commission_report_view', 'customer_commission_report_view', 'x_stock_id', 'stock_id', '`stock_id`', '`stock_id`', 200, -1, FALSE, '`stock_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->stock_id->Sortable = FALSE; // Allow sort
		$this->fields['stock_id'] = &$this->stock_id;

		// unit_price
		$this->unit_price = new cField('customer_commission_report_view', 'customer_commission_report_view', 'x_unit_price', 'unit_price', '`unit_price`', '`unit_price`', 5, -1, FALSE, '`unit_price`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->unit_price->Sortable = FALSE; // Allow sort
		$this->unit_price->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['unit_price'] = &$this->unit_price;

		// unit_tax
		$this->unit_tax = new cField('customer_commission_report_view', 'customer_commission_report_view', 'x_unit_tax', 'unit_tax', '`unit_tax`', '`unit_tax`', 5, -1, FALSE, '`unit_tax`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->unit_tax->Sortable = FALSE; // Allow sort
		$this->unit_tax->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['unit_tax'] = &$this->unit_tax;

		// invoice_amount
		$this->invoice_amount = new cField('customer_commission_report_view', 'customer_commission_report_view', 'x_invoice_amount', 'invoice_amount', '`invoice_amount`', '`invoice_amount`', 5, -1, FALSE, '`invoice_amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// discount_percent
		$this->discount_percent = new cField('customer_commission_report_view', 'customer_commission_report_view', 'x_discount_percent', 'discount_percent', '`discount_percent`', '`discount_percent`', 5, -1, FALSE, '`discount_percent`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// discount_amount
		$this->discount_amount = new cField('customer_commission_report_view', 'customer_commission_report_view', 'x_discount_amount', 'discount_amount', '`discount_amount`', '`discount_amount`', 5, -1, FALSE, '`discount_amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->discount_amount->Sortable = FALSE; // Allow sort
		$this->discount_amount->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['discount_amount'] = &$this->discount_amount;

		// govt_fee
		$this->govt_fee = new cField('customer_commission_report_view', 'customer_commission_report_view', 'x_govt_fee', 'govt_fee', '`govt_fee`', '`govt_fee`', 5, -1, FALSE, '`govt_fee`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->govt_fee->Sortable = FALSE; // Allow sort
		$this->govt_fee->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['govt_fee'] = &$this->govt_fee;

		// bank_service_charge
		$this->bank_service_charge = new cField('customer_commission_report_view', 'customer_commission_report_view', 'x_bank_service_charge', 'bank_service_charge', '`bank_service_charge`', '`bank_service_charge`', 5, -1, FALSE, '`bank_service_charge`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->bank_service_charge->Sortable = FALSE; // Allow sort
		...
		$this->bank_service_charge_vat = new cField('customer_commission_report_view', 'customer_commission_report_view', 'x_bank_service_charge_vat', 'bank_service_charge_vat', '`bank_service_charge_vat`', '`bank_service_charge_vat`', 5, -1, FALSE, '`bank_service_charge_vat`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->bank_service_charge_vat->Sortable = FALSE; // Allow sort
		...
		// pf_amount
		$this->pf_amount = new cField('customer_commission_report_view', 'customer_commission_report_view', 'x_pf_amount', 'pf_amount', '`pf_amount`', '`pf_amount`', 5, -1, FALSE, '`pf_amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->pf_amount->Sortable = FALSE; // Allow sort
		$this->pf_amount->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['pf_amount'] = &$this->pf_amount;

		// transaction_id
		$this->transaction_id = new cField('customer_commission_report_view', 'customer_commission_report_view', 'x_transaction_id', 'transaction_id', '`transaction_id`', '`transaction_id`', 200, -1, FALSE, '`transaction_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->transaction_id->Sortable = FALSE; // Allow sort
		$this->fields['transaction_id'] = &$this->transaction_id;

		// user_commission
		$this->user_commission = new cField('customer_commission_report_view', 'customer_commission_report_view', 'x_user_commission', 'user_commission', '`user_commission`', '`user_commission`', 5, -1, FALSE, '`user_commission`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->user_commission->Sortable = FALSE; // Allow sort
		$this->user_commission->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['user_commission'] = &$this->user_commission;

		// total_commission
		$this->total_commission = new cField('customer_commission_report_view', 'customer_commission_report_view', 'x_total_commission', 'total_commission', '`total_commission`', '`total_commission`', 5, -1, FALSE, '`total_commission`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->total_commission->Sortable = FALSE; // Allow sort
		$this->total_commission->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['total_commission'] = &$this->total_commission;

		// created_by
		$this->created_by = new cField('customer_commission_report_view', 'customer_commission_report_view', 'x_created_by', 'created_by', '`created_by`', '`created_by`', 3, -1, FALSE, '`created_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->created_by->Sortable = FALSE; // Allow sort
		$this->created_by->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['created_by'] = &$this->created_by;

		// updated_by
		$this->updated_by = new cField('customer_commission_report_view', 'customer_commission_report_view', 'x_updated_by', 'updated_by', '`updated_by`', '`updated_by`', 3, -1, FALSE, '`updated_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// created_employee
		$this->created_employee = new cField('customer_commission_report_view', 'customer_commission_report_view', 'x_created_employee', 'created_employee', '`created_employee`', '`created_employee`', 200, -1, FALSE, '`created_employee`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->created_employee->Sortable = FALSE; // Allow sort
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`customer_commission_report_view`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "customer_commission_report_viewlist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		global $Language;
		if ($pageName == "customer_commission_report_viewview.php")
			return $Language->Phrase("View");
		elseif ($pageName == "customer_commission_report_viewedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "customer_commission_report_viewadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("customer_commission_report_viewview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("customer_commission_report_viewview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "customer_commission_report_viewadd.php?" . $this->UrlParm($parm);
		else
			$url = "customer_commission_report_viewadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("customer_commission_report_viewedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("customer_commission_report_viewadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("customer_commission_report_viewdelete.php", $this->UrlParm());
	}
	...
	function LoadListRowValues(&$rs) {
		...
		$this->customer_commission->setDbValue($rs->fields('customer_commission'));
	...
	function RenderEditRow() {
		...
		$this->customer_commission->EditValue = $this->customer_commission->CurrentValue;
		$this->customer_commission->PlaceHolder = ew_RemoveHtml($this->customer_commission->FldCaption());
		if (strval($this->customer_commission->EditValue) <> "" && is_numeric($this->customer_commission->EditValue)) $this->customer_commission->EditValue = ew_FormatNumber($this->customer_commission->EditValue, -2, -1, -2, 0);
		...
		if (strval($this->total_commission->EditValue) <> "" && is_numeric($this->total_commission->EditValue)) $this->total_commission->EditValue = ew_FormatNumber($this->total_commission->EditValue, -2, -1, -2, 0);
		...
		$this->created_employee->EditValue = $this->created_employee->CurrentValue;
		$this->created_employee->PlaceHolder = ew_RemoveHtml($this->created_employee->FldCaption());
	...
	function ExportDocument(&$Doc, &$Recordset, $StartRec, $StopRec, $ExportPageType = "") {
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->customer_commission->Exportable) $Doc->ExportCaption($this->customer_commission);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->customer_commission->Exportable) $Doc->ExportField($this->customer_commission);
		...
		if ($Doc->Horizontal) {
			...
			if (!$Doc->ExportCustom) {
				...
				if ($this->customer_commission->Exportable) $Doc->ExportAggregate($this->customer_commission, 'TOTAL');
				if ($this->quantity->Exportable) $Doc->ExportAggregate($this->quantity, 'TOTAL');
				if ($this->total_customer_commission->Exportable) $Doc->ExportAggregate($this->total_customer_commission, 'TOTAL');
				$Doc->EndExportRow();
			}
		}
		if (!$Doc->ExportCustom) {
