...
$daily_report_view = NULL;

//
// Table class for daily_report_view
//
class cdaily_report_view extends cTable {
	var $invoice_count;
	var $tran_date;
	...
	function __construct() {
		...
		$this->TableVar = 'daily_report_view';
		$this->TableName = 'daily_report_view';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`daily_report_view`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// invoice_count
		$this->invoice_count = new cField('daily_report_view', 'daily_report_view', 'x_invoice_count', 'invoice_count', '`invoice_count`', '`invoice_count`', 20, -1, FALSE, '`invoice_count`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tran_date
		$this->tran_date = new cField('daily_report_view', 'daily_report_view', 'x_tran_date', 'tran_date', '`tran_date`', ew_CastDateFieldForLike('`tran_date`', 0, "DB"), 133, 0, FALSE, '`tran_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// total_service_count
		$this->total_service_count = new cField('daily_report_view', 'daily_report_view', 'x_total_service_count', 'total_service_count', '`total_service_count`', '`total_service_count`', 20, -1, FALSE, '`total_service_count`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->total_invoice_amount = new cField('daily_report_view', 'daily_report_view', 'x_total_invoice_amount', 'total_invoice_amount', '`total_invoice_amount`', '`total_invoice_amount`', 5, -1, FALSE, '`total_invoice_amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->total_amount_recieved = new cField('daily_report_view', 'daily_report_view', 'x_total_amount_recieved', 'total_amount_recieved', '`total_amount_recieved`', '`total_amount_recieved`', 5, -1, FALSE, '`total_amount_recieved`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// pending_amount
		$this->pending_amount = new cField('daily_report_view', 'daily_report_view', 'x_pending_amount', 'pending_amount', '`pending_amount`', '`pending_amount`', 5, -1, FALSE, '`pending_amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->total_service_charge = new cField('daily_report_view', 'daily_report_view', 'x_total_service_charge', 'total_service_charge', '`total_service_charge`', '`total_service_charge`', 5, -1, FALSE, '`total_service_charge`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// total_commission
		$this->total_commission = new cField('daily_report_view', 'daily_report_view', 'x_total_commission', 'total_commission', '`total_commission`', '`total_commission`', 5, -1, FALSE, '`total_commission`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// total_collection
		$this->total_collection = new cField('daily_report_view', 'daily_report_view', 'x_total_collection', 'total_collection', '`total_collection`', '`total_collection`', 5, -1, FALSE, '`total_collection`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`daily_report_view`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "daily_report_viewlist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		global $Language;
		if ($pageName == "daily_report_viewview.php")
			return $Language->Phrase("View");
		elseif ($pageName == "daily_report_viewedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "daily_report_viewadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("daily_report_viewview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("daily_report_viewview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "daily_report_viewadd.php?" . $this->UrlParm($parm);
		else
			$url = "daily_report_viewadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("daily_report_viewedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("daily_report_viewadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("daily_report_viewdelete.php", $this->UrlParm());
	}
	...
	function RenderEditRow() {
		...
		$this->tran_date->EditValue = ew_FormatDateTime($this->tran_date->CurrentValue, 8);
		...
		if (strval($this->total_invoice_amount->EditValue) <> "" && is_numeric($this->total_invoice_amount->EditValue)) $this->total_invoice_amount->EditValue = ew_FormatNumber($this->total_invoice_amount->EditValue, -2, -1, -2, 0);
		...
		if (strval($this->total_amount_recieved->EditValue) <> "" && is_numeric($this->total_amount_recieved->EditValue)) $this->total_amount_recieved->EditValue = ew_FormatNumber($this->total_amount_recieved->EditValue, -2, -1, -2, 0);
		...
		if (strval($this->pending_amount->EditValue) <> "" && is_numeric($this->pending_amount->EditValue)) $this->pending_amount->EditValue = ew_FormatNumber($this->pending_amount->EditValue, -2, -1, -2, 0);
		...
		if (strval($this->total_service_charge->EditValue) <> "" && is_numeric($this->total_service_charge->EditValue)) $this->total_service_charge->EditValue = ew_FormatNumber($this->total_service_charge->EditValue, -2, -1, -2, 0);
		...
		if (strval($this->total_collection->EditValue) <> "" && is_numeric($this->total_collection->EditValue)) $this->total_collection->EditValue = ew_FormatNumber($this->total_collection->EditValue, -2, -1, -2, 0);
