...
$single_user_transaction_report_view = NULL;

//
// Table class for single_user_transaction_report_view
//
class csingle_user_transaction_report_view extends cTable {
	var $account_code;
	var $account_name;
	var $tran_date;
	var $user_id;
	...
	function __construct() {
		...
		$this->TableVar = 'single_user_transaction_report_view';
		$this->TableName = 'single_user_transaction_report_view';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`single_user_transaction_report_view`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// account_code
		$this->account_code = new cField('single_user_transaction_report_view', 'single_user_transaction_report_view', 'x_account_code', 'account_code', '`account_code`', '`account_code`', 200, -1, FALSE, '`account_code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->account_code->Sortable = TRUE; // Allow sort
		$this->fields['account_code'] = &$this->account_code;

		// account_name
		$this->account_name = new cField('single_user_transaction_report_view', 'single_user_transaction_report_view', 'x_account_name', 'account_name', '`account_name`', '`account_name`', 200, -1, FALSE, '`account_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->account_name->Sortable = TRUE; // Allow sort
		$this->fields['account_name'] = &$this->account_name;

		// tran_date
		$this->tran_date = new cField('single_user_transaction_report_view', 'single_user_transaction_report_view', 'x_tran_date', 'tran_date', '`tran_date`', ew_CastDateFieldForLike('`tran_date`', 2, "DB"), 133, 2, FALSE, '`tran_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// user_id
		$this->user_id = new cField('single_user_transaction_report_view', 'single_user_transaction_report_view', 'x_user_id', 'user_id', '`user_id`', '`user_id`', 18, -1, FALSE, '`user_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// amount
		$this->amount = new cField('single_user_transaction_report_view', 'single_user_transaction_report_view', 'x_amount', 'amount', '`amount`', '`amount`', 5, -1, FALSE, '`amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->amount->Sortable = TRUE; // Allow sort
		$this->amount->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['amount'] = &$this->amount;

		// type_no
		$this->type_no = new cField('single_user_transaction_report_view', 'single_user_transaction_report_view', 'x_type_no', 'type_no', '`type_no`', '`type_no`', 3, -1, FALSE, '`type_no`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->type_no->Sortable = TRUE; // Allow sort
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`single_user_transaction_report_view`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "single_user_transaction_report_viewlist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		global $Language;
		if ($pageName == "single_user_transaction_report_viewview.php")
			return $Language->Phrase("View");
		elseif ($pageName == "single_user_transaction_report_viewedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "single_user_transaction_report_viewadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("single_user_transaction_report_viewview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("single_user_transaction_report_viewview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "single_user_transaction_report_viewadd.php?" . $this->UrlParm($parm);
		else
			$url = "single_user_transaction_report_viewadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("single_user_transaction_report_viewedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("single_user_transaction_report_viewadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("single_user_transaction_report_viewdelete.php", $this->UrlParm());
	}
	...
	function Recordset_Selecting(&$filter) {
		...
		//var_dump($_SESSION['amer_reports_status_UserName']); die;
