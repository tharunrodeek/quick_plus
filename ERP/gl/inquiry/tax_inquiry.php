...
page(trans($help_context = "Tax Inquiry"), false, false, '', $js);
...
function tax_inquiry_controls()
{
	...
	date_cells(trans("from:"), 'TransFromDate', '', null, -user_transaction_days());
...
function show_results()
{
	...
	$th = array(trans("Type"), trans("Description"), trans("Amount"), trans("Outputs")."/".trans("Inputs"));
	table_header($th);
	$k = 0;
	$total = 0;
