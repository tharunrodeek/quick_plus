...
function gl_inquiry_controls()
{
	...
	start_row();
    gl_all_accounts_list_cells(trans("Account:"), 'account', null, false, false, trans("All Accounts"));
...
function show_results()
{
	...
	if ($show_balances)
	    $remaining_cols = array(trans("Person/Item"), trans("Debit"), trans("Credit"), trans("Balance"), trans("Memo"), "");
	else
