...
$_SESSION['page_title'] = trans($help_context = trans("Search General Ledger Transactions for account: ").$_GET['act']);
...
{ /*Script was not passed the correct parameters */
	...
	echo "<p>" . trans("The script must be called with a valid transaction type and transaction number to review the general ledger postings for.") . "</p>";
	exit;
}
...
$first_cols = array(trans("Type"), "#", trans("Date"));
if ($dim == 2)
...
$remaining_cols = array(trans("Person/Item"), trans("Debit"), trans("Credit"), trans("Memo"));
