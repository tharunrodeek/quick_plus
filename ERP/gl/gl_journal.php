    ...
    if ($trans_no) {
        ...
        if ($result) {
            while ($row = db_fetch($result)) {
                ...
                //SUB-LEDGER-AXISPRO
                $_SESSION['journal_items']->axispro_subledger_code = $row['axispro_subledger_code'];
...
function handle_update_item()
{
    if ($_POST['UpdateItem'] != "" && check_item_data()) {
        ...
        //SUB-LEDGER-AXISPRO
        $_SESSION['journal_items']->axispro_subledger_code = get_post('axispro_subledger_code');
        ...
        $_SESSION['journal_items']->gl_items[$_POST['Index']]->axispro_subledger_code = get_post('axispro_subledger_code');
...
echo "<style>
                table.tablestyle td:first-child, table.tablestyle td:nth-child(3) {width: auto !important;}
                select {
    max-width: 220px;
}
