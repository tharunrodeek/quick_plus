...
include_once($path_to_root . "/themes/daxis/logout.php");
...
echo trans("Thank you for using") . " ";
...
echo "</font></div></td>
  ...
  <tr>
    <td><div align='center'>";
echo "<a href='$path_to_root/index.php'><b>" . trans("Click here to Login Again.") . "</b></a>";
echo "</div></td>
  </tr>
</table>
<br>\n";
