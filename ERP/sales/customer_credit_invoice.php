...
function display_credit_items()
{
    ...
    label_cells(trans("Crediting Invoice"), get_customer_trans_view_str(ST_SALESINVOICE, array_keys($_SESSION['Items']->src_docs)), "class='tableheader2'");
    ...
    label_row(trans("Invoice Date"), $_SESSION['Items']->src_date, "class='tableheader2'");

    date_row(trans("Credit Note Date"), 'CreditDate', '', $_SESSION['Items']->trans_no==0, 0, 0, 0, "class='tableheader2'");
    ...
    $th = array(trans("Item Code"), trans("Item Description"), trans("Invoiced Quantity"), trans("Units"),
    	trans("Credit Quantity"), trans("Price"), trans("Discount %"), trans("Total"));
    table_header($th);
    ...
    label_row(trans("Credit Note Total"), $display_total, "colspan=$colspan align=right", "align=right");
