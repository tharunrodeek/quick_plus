...
start_table(false, "", '5', '0', "w-50 p-4");
start_row();
customer_list_cells(trans("Select a customer: "), 'customer_id', $_POST['customer_id'], '--all customers--', true);
check_cells(trans("Show Settled Items:"), 'ShowSettled', null, true);
echo '<td>&nbsp;</td>';
echo '<td>&nbsp;</td>';
submit_cells('auto_allocate', trans('Allocate All'), "", "Allocate all transactions of selected customer", 'process default');
end_row();
end_table();
