...
@section('content')
    ...
    <h4 class="m-b-20">Customer Commission Report</h4>
    <div class="btn-group" role="group" aria-label="Basic example">
        <button type="button" data-url="{{route('customer_commission_report.export','xlsx')}}" class="export_button btn btn-info">
            Excel
        </button>
        <button type="button" data-url="{{route('customer_commission_report.export','pdf')}}" class="export_button btn btn-info">
            PDF
        </button>
    </div>
    ...
    <div class="row">
        <div class="col-xs-12">
            {!! Form::open(['route' => 'customer_commission_report.list','method' => 'get']) !!}
