...
<!--        <div class="col-lg-3 col-md-6 col-sm-6 " style="cursor: pointer"-->
<!--             onclick="window.location.href='sales-tasheel/sales_order_entry.php?NewInvoice=0&is_tadbeer=1&show_items=tb'">-->
<!--            <div class="card card-stats card_box">-->
<!---->
<!--                <div class="card-content-tiny">-->
<!--                    <div class="title">--><?php //echo trans("Tad-beer Invoice") ?><!--</div>-->
<!--                </div>-->
<!--                <div class="card-icon">-->
<!--                    <i class="icon-local_printshop"></i>-->
<!--                </div>-->
...
<!--        </div>-->
        ...
        <?php if(!in_array($_SESSION['wa_current_user']->access,[3]) ) {
            ?>



            <div class="col-lg-3 col-md-6 col-sm-6 " style="cursor: pointer"
                 onclick="window.location.href='themes/daxis/front-desk.php?'">
                <div class="card card-stats card_box">

                    <div class="card-content-tiny">
                        <div class="title"><?php echo trans("Reception") ?></div>
                    </div>
                    <div class="card-icon">
                        <i class="icon-user"></i>
                    </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 " style="cursor: pointer"
             onclick="window.location.href='sales/customer_payments.php'">
            <div class="card card-stats card_box">

                <div class="card-content-tiny">
                    <div class="title"><?php echo trans("Invoice Payment") ?></div>
                    <!--                    <p class="stats" style="text-align: center">-->
                    <?php //echo trans("Direct Invoice");
                    ?><!--</p>-->
                </div>
                <div class="card-icon">
        ...
        <?php }
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 " style="cursor: pointer"
                 onclick="loadOldReport();">
                <div class="card card-stats card_box">

                    <div class="card-content-tiny">
                        <div class="title"><?php echo trans("Reports") ?></div>
                        <!--                    <p class="stats" style="text-align: center">-->
                        <?php //echo trans("Direct Invoice");
                        ?><!--</p>-->
                    </div>
    ...
    <?php if(in_array($_SESSION['wa_current_user']->access,[9,2]) ) {
        ...
        <div class="row dx-cls">
            <div class="dashboard_stats">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 " style="cursor: pointer"
                                         onclick="window.location.href='gl/gl_journal.php?NewJournal=Yes'">
                                        <div class="card card-stats card_box">
                                            <div class="card-content-tiny">
                                                <div class="title"><?php echo trans("Journal Entry") ?></div>
                                            </div>
                                            <div class="card-icon">
...
<!--                <div class="col-lg-3 col-md-6 col-sm-6 " style="cursor: pointer"-->
<!--                     onclick="window.location.href='reporting/reports_main.php?Class=6'">-->
<!--                    <div class="card card-stats card_box">-->
<!--                        <div class="card-content-tiny">-->
<!--                            <div class="title">--><?php //echo trans("GL Reports") ?><!--</div>-->
<!--                        </div>-->
<!--                        <div class="card-icon">-->
<!--                            <i class="icon-local_printshop"></i>-->
<!--                        </div>-->
...
<!--                <div class="col-lg-3 col-md-6 col-sm-6 " style="cursor: pointer"-->
<!--                     onclick="window.location.href='sales/inquiry/credit_request_list.php?'">-->
<!--                    <div class="card card-stats card_box">-->
<!---->
<!---->
<!--                        <div class="card-content-tiny">-->
<!--                            <div class="title">--><?php //echo trans("Credit Limit Requests") ?><!--</div>-->
<!--                        </div>-->
<!---->
<!---->
<!--                        <div class="card-icon">-->
...
<div class="card-content table-responsive">
        ...
        <div class="col-sm-6" id="item-16">
            <div class="card panel-body pheight400">
                <div class="card-header" data-background-color="orange">
                    <h4 class="title"><?php echo trans("Service Count Report") ?></h4>
                </div>
        ...
        <div class="col-sm-6 col-sm-12">
            <div class="card panel-body ">
                <div class="card-header" data-background-color="orange">
                    ...
                    <!-- <p class="category">All Associated Account Balances</p>-->
                </div>
                <div class="card-content table-responsive">
                    <?php kv_bank_balance(); ?>
                </div>
    ...
    <div class="col-sm-6" id="item-16" style="clear: both; float: left">
        <div class="card panel-body">
            ...
            <div style="text-align: center; padding: 5px">
                ...
                <?php } else {
                    echo "<hidden value='-1' id='pay_status' >";
                } ?>
