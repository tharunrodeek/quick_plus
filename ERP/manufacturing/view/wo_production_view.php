...
page(trans($help_context = "View Work Order Production"), true, false, "", $js);
...
function display_wo_production($prod_id)
{
    ...
    $th = array(trans("Production #"), trans("Reference"), trans("For Work Order #"),
    	trans("Item"), trans("Quantity Manufactured"), trans("Date"));
    table_header($th);
	...
	is_voided_display(ST_MANURECEIVE, $prod_id, trans("This production has been voided."));
}
