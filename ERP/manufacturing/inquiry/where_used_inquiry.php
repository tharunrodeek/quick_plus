...
page(trans($help_context = "Inventory Item Where Used Inquiry"));
...
echo "<center>" . trans("Select an item to display its parent item(s).") . "&nbsp;";
...
$sql = get_sql_for_where_used(get_post('stock_id'));
   ...
   $cols = array(
   	trans("Parent Item") => array('fun'=>'select_link'),
	trans("Work Centre"),
	trans("Location"),
