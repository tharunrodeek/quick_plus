...
{
    // print_document_link($doc_no, $link_text, $link=true, $type_no,$icon=false, $class='printlink', $id='', $email=0, $extra=0,$voided=false)
...
//	$not_implemented =  array(ST_PURCHORDER, ST_SALESORDER, ST_SALESQUOTE, ST_COSTUPDATE);
    $not_implemented = array(
        ...
        ST_BANKDEPOSIT, ST_CUSTCREDIT, ST_DIMENSION,
    ...
    $optios='';
    if($_POST['filterType']=='10')
    {
        $optios='<option value="">---Choose---</option>
    ...
    echo '<td>
       Edit/Voided :
        ...
        <td><select name="ddl_edit_voided">';
    echo $optios;
...
//    get_tran
    ...
    $trans_ref = false;
    $sql = get_sql_for_view_transactions_edited(get_post('filterType'), get_post('FromTransNo'), get_post('ToTransNo'), $trans_ref, $trans_ref_no,$voided = true,get_post('ddl_edit_voided'));
