...
page(trans($help_context = "Suppliers"), true, false, "", $js);
...
text_cells(trans("Supplier"), "supplier");
submit_cells("search", trans("Search"), "", trans("Search suppliers"), "default");
...
$th = array("", trans("Supplier"), trans("Short Name"), trans("Address"), trans("Tax ID"));
