...
if (isset($_GET['AddedID'])) {
	...
	if (!isset($_GET['prepaid']))
		hyperlink_params("$path_to_root/sales-tasheel/customer_invoice.php", trans("Invoice This Delivery"), "DeliveryNumber=$dispatch_no");

	hyperlink_params("$path_to_root/sales-tasheel/inquiry/sales_orders_view.php", trans("Select Another Order For Dispatch"), "OutstandingOnly=1");
	...
	if (!isset($_GET['prepaid']))
		hyperlink_params($path_to_root . "/sales-tasheel/customer_invoice.php", trans("Confirm Delivery and Invoice"), "DeliveryNumber=$delivery_no");

	hyperlink_params($path_to_root . "/sales-tasheel/inquiry/sales_deliveries_view.php", trans("Select A Different Delivery"), "OutstandingOnly=1");
...
if (isset($_GET['OrderNumber']) && $_GET['OrderNumber'] > 0) {
	...
	if ($ord->count_items() == 0) {
		hyperlink_params($path_to_root . "/sales-tasheel/inquiry/sales_orders_view.php",
		...
		hyperlink_params($path_to_root . "/sales-tasheel/inquiry/sales_orders_view.php",trans("Select a different sales order to delivery"),
			"OutstandingOnly=1");
	...
	hyperlink_params("$path_to_root/sales-tasheel/inquiry/sales_orders_view.php", trans("Select a Sales Order to Delivery"), "OutstandingOnly=1");
