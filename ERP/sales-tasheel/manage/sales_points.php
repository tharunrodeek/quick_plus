...
include_once($path_to_root . "/sales-tasheel/includes/db/sales_points_db.inc");
...
$th = array (trans('POS Name'), trans('Credit sale'), trans('Cash sale'), trans('Location'), trans('Default account'),
	 '','');
