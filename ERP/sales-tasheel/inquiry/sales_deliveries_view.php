...
include($path_to_root . "/sales-tasheel/includes/sales_ui.inc");
...
if (isset($_POST['BatchInvoice']))
{
    ...
    if (!$del_count) {
		...
		meta_forward($path_to_root . '/sales-tasheel/customer_invoice.php','BatchInvoice=Yes');
    }
}
...
{
	return $row["Outstanding"]==0 ? '' :
		pager_link(trans('Invoice'), "/sales-tasheel/customer_invoice.php?DeliveryNumber="
