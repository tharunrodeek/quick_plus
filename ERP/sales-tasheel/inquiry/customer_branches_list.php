...
include_once($path_to_root . "/sales-tasheel/includes/db/branches_db.inc");

$js = get_js_select_combo_item();

page(trans($help_context = "Customer Branches"), true, false, "", $js);
...
text_cells(trans("Branch"), "branch");
submit_cells("search", trans("Search"), "", trans("Search branches"), "default");
...
$th = array("", trans("Ref"), trans("Branch"), trans("Contact"), trans("Phone"));
