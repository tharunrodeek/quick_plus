...
include_once($path_to_root . "/sales-tasheel/includes/db/customers_db.inc");
...
page(trans($help_context = "Customers"), true, false, "", $js);
...
text_cells(trans("Customer"), "customer");
submit_cells("search", trans("Search"), "", trans("Search customers"), "default");
...
$th = array("", trans("Customer"), trans("Short Name"), trans("Address"), trans("Tax ID"));
