...
function print_payment_report()
{
	...
	$headers = array(trans('Trans Type'), trans('#'), trans('Due Date'), '', '',
		'', trans('Total'), trans('Balance'));
    ...
    $rep = new FrontReport(trans('Payment Report'), "PaymentReport", user_pagesize(), 9, $orientation);
    if ($orientation == 'L')
