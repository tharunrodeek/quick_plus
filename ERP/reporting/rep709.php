...
function print_tax_report()
{
	...
	$rep = new FrontReport(trans('Tax Report'), "TaxReport", user_pagesize(), 9, $orientation);
	if ($summaryOnly == 1)
	...
	$headers = array(trans('Trans Type'), trans('Ref'), trans('Date'), trans('Name'), trans('Branch Name'),
		trans('Net'), trans('Rate'), trans('Tax'), '', trans('Name'));
