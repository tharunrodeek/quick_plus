...
function print_aged_customer_analysis()
{
    ...
    $cols = array(0, 100, 130, 190,	250, 320, 385, 450,	515,600);
...
//        $headers[2] = _('Currency');
    $rep = new FrontReport(_('Aged Customer Analysis'), "AgedCustomerAnalysis", 'A3', 9, $orientation);
    if ($orientation == 'L')
    ...
    while ($myrow=db_fetch($result))
    {
        ...
        if (!$summaryOnly)
        {
            ...
            {
                $rep->NewLine(1, 2);
                $rep->TextCol(0, 1, ltrim($systypes_array[$trans['type']],"Sales "), -2);
