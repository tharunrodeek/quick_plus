...
function print_bill_of_material()
{
	...
	$headers = array(trans('Component'), trans('Description'), trans('Loc'), trans('Wrk Ctr'), trans('Quantity'));

	$aligns = array('left',	'left',	'left', 'left', 'right');

    $params =   array( 	0 => $comments,
    				    1 => array('text' => trans('Component'), 'from' => $frompart, 'to' => $topart));

    $rep = new FrontReport(trans('Bill of Material Listing'), "BillOfMaterial", user_pagesize(), 9, $orientation);
    if ($orientation == 'L')
