...
function print_annual_expense_breakdown()
{
    ...
    if ($dim == 2)
    {
    	$params =   array( 	0 => $comments,
                    	...
                    	5 => array('text' => trans('Info'), 'from' => trans('Amounts in thousands'),
                    		'to' => ''));
    }
    elseif ($dim == 1)
    {
    	$params =   array( 	0 => $comments,
                    	...
                    	4 => array('text' => trans('Info'), 'from' => trans('Amounts in thousands'),
                    		'to' => ''));
    }
    else
    {
    	$params =   array( 	0 => $comments,
                    	...
                    	3 => array('text' => trans('Info'), 'from' => trans('Amounts in thousands'),
                    		'to' => ''));
    }

	$rep = new FrontReport(trans('Annual Expense Breakdown'), "AnnualBreakDown", user_pagesize(), 9, $orientation);
    if ($orientation == 'L')
