...
function print_Chart_of_Accounts()
{
	...
	$headers = array(trans('Account'), trans('Account Name'), trans('Account Code'), trans('Balance'));
	
	$aligns = array('left',	'left',	'left',	'right');
	
	$params = array(0 => $comments);

	$rep = new FrontReport(trans('Chart of Accounts'), "ChartOfAccounts", user_pagesize(), 9, $orientation);
    if ($orientation == 'L')
