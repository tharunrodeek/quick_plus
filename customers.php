        ...
        AxisPro.APICall('GET', ERP_FUNCTION_API_END_POINT, {
            ...
            if(data) {
                ...
                $.each(data, function(key,value) {
                    ...
                    tbody_html+="<tr>";
                    tbody_html+="<td>"+value.cust.debtor_ref+"</td>";
                    tbody_html+="<td>"+value.cust.name+"</td>";
                    tbody_html+="<td>"+value.cust.pro_name+"</td>";
                    tbody_html+="<td>"+value.cust.address+"</td>";
                    tbody_html+="<td>"+value.cust.mobile+"</td>";
                    tbody_html+="<td>"+value.cust.debtor_email+"</td>";
                    tbody_html+="<td>"+value.cust.tax_id+"</td>";
                    value.line.forEach(function(linedata) {

                        if(value.discdata[linedata.category_id]) {
                            var total = parseInt(value.discdata[linedata.category_id].discount)+parseInt(value.discdata[linedata.category_id].customer_commission);
                            var total = value.discdata[linedata.category_id].discount;
                            tbody_html+="<td>"+total+"</td>";
                        }else{
                            tbody_html+="<td>--</td>";
                        }
                    ...
                    /*tbody_html+="<td><a href='"+BASE_URL+"items.php?action=edit&edit_stock_id="+value.cust.stock_id+"' " +
