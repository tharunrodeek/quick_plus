...
<div class="kt-container  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-grid--stretch">
 ...
 <input type="hidden" id="hdnTxtpay" />
 <input type="hidden" id="hdnTxtDed" />
 <input type="hidden" id="hdnPayableAcc" />
 <input type="hidden" id="hdnDedctionAcc" />
 <input type="hidden" id="hdnOvertimeAcc" />
 <input type="hidden" id="hdnGrossSalaryAcc" />
