                        ...
                        <div class="kt-portlet__body" style="padding: 5px !important;">
                            <div class="row">
                                ...
                                <div class="col-md-8 ClsshowESB" style="display: none;">
                                    ...
                                    <div class="card card-custom example example-compact">
                                        <div class="form-group row fv-plugins-icon-container">
                                            <label class="col-form-label text-right col-lg-3 col-sm-12" style="font-weight:bold;">ESB Calaculated</label>
                                            <div class="col-lg-3 col-md-9 col-sm-12" style="    margin-top: 1%;">
   ...
   $('.btn-pill').click(function()
   {
       ...
       else
       {
           AxisPro.APICall('POST', ERP_FUNCTION_API_END_POINT + "?method=create_esb",
               'empl_id='+empl_id+'&years='+years+'&loan_amnt='+loan_amnt+'&warn_amnt='+warn_amnt+'&esb_amnt='+esb_amnt+'&dept_id='+$('.ap_department').val()
               , function (data)
               {
                  if(data.status=='OK')
                  {
