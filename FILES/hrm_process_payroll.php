            ...
            +"&year="+$("#ddl_year").val()+"&month="+$(".ClsMonths").val(), function (resdata) {
                ...
                $('.txt_amt').change(function()
                {
                   ...
                   /* if(replace_tot_ear>0)
                    ...
                    $('#txt_tot_salary_dedn_'+alt_row_id).val(tot_dedn);

                    var tot_salary=$('#hdn_tot_salary_include_overtime_'+alt_row_id).val();
                    $('#txt_empl_tot_salary_'+alt_row_id).val(tot_salary-tot_dedn+parseFloat(replace_tot_ear));
                    var paid_sary=$('#lblPaid_salary_'+alt_row_id).html();
                    if(paid_sary==undefined)
                    {
                        paid_sary=0;
                    }
                    else
                    {
                        paid_sary =paid_sary.replace(',',"");
                    }
                    $('#txtTotal_salary_paying_'+alt_row_id).val($('#txt_empl_tot_salary_'+alt_row_id).val());
                });
                ...
                $('.cls_earnings_amt').change(function()
                {
                    ...
                    $('#txtTotal_salary_paying_'+alt_row_id).val(parseFloat(tot_salary)+parseFloat(replace_tot_ear));
                });
                ...
                {
                    var alt=$(this).attr('alt');
                    //alert($('#txtTotal_salary_'+alt).val()+' / '+$('#txt_commission_'+alt).val());
                    $('#txt_net_commision_'+alt).val($('#txt_commission_'+alt).val()-$('#txtTotal_salary_'+alt).val());

                    if($('#txt_net_commision_'+alt).val()!=undefined)
                    {
                        var tot=parseFloat($('#txt_empl_tot_salary_'+alt).val())+parseFloat($('#txt_net_commision_'+alt).val());

                        $('#txtTotal_salary_paying_'+alt).val(tot);
                ...
                function calculate_tot_salry_ded(alt) {
                   ...
                   /* var ot_amount=$('#txt_otAmount_'+alt).val();*/
                    ...
                    $('#txt_empl_tot_salary_'+alt).val(emp_tot_salry-merge_sum);
                    ...
                    $('#txtTotal_salary_paying_'+alt).val(parseFloat($('#txt_empl_tot_salary_'+alt).val())+parseFloat(commsion));
                }
        ...
        if(cnfrm==true)
        {
            ...
            if(flag=='')
            {
                AxisPro.APICall('POST',
                    ERP_FUNCTION_API_END_POINT + "?method=process_payroll",{'salaries':process_salary,'from_account':$('.ddl_salaryFrmAccount').val()},
                    function (data) {
                        if(data.status=='OK')
                        {
