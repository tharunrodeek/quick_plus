			...
			if ($('#'+id).length == 0) {
				...
				table.append(
					$(options.rowTpl)
						...
						.append($(options.cellTpl).append($(options.buttonFunctionTpl).html(options.textDelete).addClass('btn-outline-danger del').click(function(){
					...
					$(options.rowTpl)
						...
						.append($(options.cellTpl).append($(options.buttonFunctionTpl).html(options.textClear).addClass('btn-outline-secondary clear').click(function(){
							nmpd.setValue('');
						})))
					).append(
					$(options.rowTpl)
						...
						.append($(options.cellTpl).append($(options.buttonFunctionTpl).html(options.textCancel).addClass('btn-outline-info cancel').click(function(){
							nmpd.close(false);
						})))
					).append(
					$(options.rowTpl)
						...
						.append($(options.cellTpl).append($(options.buttonFunctionTpl).html(options.decimalSeparator).addClass('btn-block btn-outline-primary sep').click(function(){
							nmpd.setValue(nmpd.getValue().toString() + options.decimalSeparator);
						})))
						.append($(options.cellTpl).append($(options.buttonFunctionTpl).html(options.textDone).addClass('btn-outline-success done')))
					);
